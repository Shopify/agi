...
def test_extract_simple_concepts(request):
    ...
    expected_response = {
        "concepts": ["France", "Country", "Europe"],
        "relationships": [
            {
                "source": "France",
    ...
    expected_response = {
        ...
        "relationships": [
            ...
            },
            {
                ...
                "target": "Salvador Dalí",
                "strength": 1.0,
            },
            {
                "source": "Salvador Dalí",
                "relationship": "type_of",
                "target": "Spanish surrealist painter",
                "strength": 1.0,
            },
            {
                "source": "The Seven Lively Arts",
