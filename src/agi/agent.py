...
class Agent:
    ...
    def interact(self, message):
        ...
        if message_classification['interaction_type'] == 'factual':
            print(f"Agent is {message_classification['confidence']} confident that this is a factual message")
            ...
            print(f"Agent is {message_classification['confidence']} confident that this is an interrogative message")
            pass
            # look up identified concepts
